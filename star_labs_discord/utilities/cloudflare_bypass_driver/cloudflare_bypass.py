...
class CloudflareBypasser:
    ...
    def get_cloudflare_cookie(self):
        ...
        random_url_code = self._generate_cf_random_url()

        r = self.client.post(f'https://discord.com/cdn-cgi/challenge-platform/h/b/jsd/r/{random_url_code}', json=payload)
    ...
    def get_cf_clearance(self) -> bool:
        if not self.get_cloudflare_cookie():
            return False
        else:
            return True
